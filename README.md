...
Requirements: Python 3.11+, Python packages: pandas requests steam tqdm:
...
python ./export.py --steam-api-key XXXXXXXXXXXXXXXXXXXXXXXX --all-friends  # when GOG and Steam are linked, otherwise --steam-id must be set
```

Usage: `python export.py [-h] [--tags] [--steam-id STEAM_ID] [--steam-api-key STEAM_API_KEY] [--all-friends]
[--friends FRIENDS] [--gog-db GOG_DB]`

Optional arguments:

```
-h, --help            show the help message and exit
--tags                Export user tags for the games
...
When using --friends or --all-friends, --steam-api-key must be set. Only Steam friends are supported, their game
collections must be public.
```
